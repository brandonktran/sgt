    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit} onReset={this.handleReset} className="mt-4">
                ...
                <div className="form-group">
                    <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-journal-text" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="form-group">
                    <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-calculator" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
